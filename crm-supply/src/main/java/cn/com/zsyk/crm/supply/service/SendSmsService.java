...
//            }
        if(phoneNum<memberList.size()){
            ...
            this.smsInvoke(smsUrl, phoneList,sysSmsSendGroup.getMsgTopic() ,sysSmsSendGroup.getSendObj() ,sysSmsSendGroup.getBizNo(),sysSmsSendGroup.getMsgContent(), "", "", "");
//            flag=flag+phoneNum;
//            phoneNum=phoneNum*2;
...
//        }
     ...
     * @author
     */
    public PageBean getSendGroup() {
//        List<SysSmsSendGroup> sysSmsSendGroup = sysSmsSendGroupMapper.selectAll();
        PageBean retlst = coreDaoImpl.selectPageByMapper(sysSmsSendGroupMapper,"selectAll");
        if (null == retlst) {
     ...
     * @return 接口返回的日志信息
     */
    public Map<String, Object> smsInvoke(String url, List<String> phoneList, String msgTopic,String sendObj,String bizNo,String contents,
