...
public class CustService {
	 ...
	 * @return
	 */
	public PageBean selectBlackPerCustList(PerCustList custper) {
		
		//根据标签查询客户列表
		if(custper.getCustTagCd() == null || custper.getCustTagCd() =="") {
			PageBean pageRetlst=coreDaoImpl.selectPageByMapper(ecCustPerMapper,"selectBlackPerCustList",custper);
			...
			PageBean pageRetlst=coreDaoImpl.selectPageByMapper(ecCustPerMapper,"selectPerCustListByTag",custper);
			List<PerCustList> retlst1 = pageRetlst.getList();
			if (null != retlst1) {
