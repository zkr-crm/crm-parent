...
public class ImportLogCtrl {
	 ...
	 * @apiSuccess {EcImportLog} data 返回值对象
	 */
    @RequestMapping(value = "/crm/ecif/productmng/accountFile",method = RequestMethod.POST)
    public void  accountFile(EcImportLog importLog, String importDetsSts, HttpServletResponse response) throws Exception {
         response.setHeader("Content-Disposition", "attachment;filename=" +new String(importLog.getFileNam().getBytes("GB2312"), "ISO8859-1" ) );
