...
public class CleanCustPerService {
    ...
    public void addCustpers(String message){
        ...
        try {
            ...
            e.printStackTrace();
            amqpTemplate.convertAndSend("customerQueue_wrong", message);
        }
    }
    ...
    public void addReportorMobile(String message){
        ...
        oldecContactWay.setCustNo(ecCustPer.getCustNo());//客户号;
        oldecContactWay.setContactSqn(custContactService.getNextSqnByCustNo(ecCustPer.getCustNo()));//序号
    ...
    public void addCustPers(ECCustpers ecCustPer) {
        ...
        if(ecCustPer1!=null){
            if(ecCustPer.getCustTyp()!=null && ecCustPer.getCustTyp()!="") {
                ...
                ecCustPer1.setCustTyp(EnumType.CustType.per_formal_cust.value);
            }
    ...
    public void addCustContactAddrs(ECCustpers ecCustPer) {
        ...
        if(ecContactAddr!=null){
            if(ecCustPer.getProvCd()!=null&&!ecCustPer.getProvCd().equals("")){
                ...
                String sysPr = (String)addrDetail.getData();
                if(sysPr!=null) {
            ...
            String sysCity =null;
            if(ecCustPer.getCityCd()!=null&&!ecCustPer.getCityCd().equals("")) {
                String cityName = ecCustPer.getCityCd();
                Result addrDetail = restUtil.getForObject(ServiceType.MANAGE,
                        "/crm/manage/nameCode/getCitysCode?cityName={cityName}", Result.class, cityName);
            ...
            if(sysCity!=null&&ecCustPer.getCountyCd()!=null&&!ecCustPer.getCountyCd().equals("")) {
                String countyName = ecCustPer.getCityCd();
                Result addrDetail = restUtil.getForObject(ServiceType.MANAGE,
