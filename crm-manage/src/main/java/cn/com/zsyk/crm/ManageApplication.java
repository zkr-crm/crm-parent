...
@EnableEurekaClient//只针对Eureka实现的注册中心
//@EnableDiscoveryClient(更通用，SpringCloud可通过Eureka、Consul、Zookeeper等实现注册中心)
@SpringBootApplication
@MapperScan(value="cn.com.zsyk.crm.manage.mapper")
public class ManageApplication implements ApplicationRunner{
	private final Log logger = LogUtil.getLogger(ManageApplication.class);
    ...
    public static void main(String[] args) {
    	System.setProperty("appName","crm-manage");
