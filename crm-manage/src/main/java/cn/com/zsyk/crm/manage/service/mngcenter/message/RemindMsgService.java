...
public class RemindMsgService implements IMsgSend {
	...
	public List<SysAppRemind> getAppRemindByEmployeeId(String employeeID) {
		...
		List<SysAppRemind> infoList = daoUtil.selectList("cn.com.zsyk.crm.manage.mapper.SysAppRemindMapper.selectByEmployeeId", map);
		return infoList;
	}
	...
	public PageBean getAppRemindByEntity(SysAppRemind remindInfo) {
		if(remindInfo.getReceivUser()==null || "".equals(remindInfo.getReceivUser())){
	 ...
	 * @return
	 */
	public int modAllIsReadStat(String employeeId) {
		Map map = new HashMap();
		map.put("receivUser", employeeId);
		map.put("isRead", EnumType.YesNoFlg.yes.value);
		int delCount = daoUtil.update("cn.com.zsyk.crm.manage.mapper.SysAppRemindMapper.batchUpdateIsReadStat", map);
		return delCount;
	}
	 ...
	 * @return
	 */
	public int modAllMailIsReadStat(String employeeId) {
			Map map = new HashMap();
			map.put("mailId", employeeId);
			map.put("isRead", EnumType.YesNoFlg.yes.value);
			int delCount = daoUtil.update("cn.com.zsyk.crm.manage.mapper.SysAppMailMapper.batchUpdateIsReadMsgStat", map);
			return delCount;
	}
