...
public interface EnumType {
  ...
  enum DataSource {
  			ecif("ecif","01","Ecif系统"),
  			core_sys("core_sys","02","核心系统"),
  			Lazada("Lazada","04","电商平台"),
  			wechat_pub_act("wechat_pub_act","05","微信公众号"),
  			wechat_mimi_apps("wechat_mimi_apps","06","微信小程序"),
  			Taobao("Taobao","07","淘宝"),
  			other("other","99","其他"),
  ...
  enum CustType {
  			per_formal_cust("per_formal_cust","01","个人正式客户"),
  			ent_formal_cust("ent_formal_cust","02","企业正式客户"),
  			per_latent_cust("per_latent_cust","03","个人潜在客户"),
  			ent_latent_cust("ent_latent_cust","04","企业潜在客户"),
  			black_list_cust("black_list_cust","09","黑名单客户"),
  	;
