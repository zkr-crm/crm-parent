...
@MapperScan(value="cn.com.zsyk.crm.query.mapper")
public class QueryApplication implements ApplicationRunner {
	private final Log logger = LogUtil.getLogger(QueryApplication.class);
